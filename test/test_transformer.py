...
def test_cmake_project_creation(new_transformer: Transformer):
    ...
    make_dump = """
        CPPFLAGS_INC_LIST = -I../../MQ_123/TEST/component_a -I../../MQ_123/TEST/include_dir
        VC_SRC_LIST = main.c component_a/component_a.c
    """
    ...
    assert (
        ...
        == cmake_list_file.read_text()
    )

    cmake_legacy_parts_file = transformer.legacy_variant_dir / "parts.cmake"
    ...
    assert (
        ...
        == cmake_legacy_parts_file.read_text()
    )

    cmake_legacy_list_file = transformer.legacy_dir / "CMakeLists.txt"
    ...
    assert (
        ...
        == cmake_legacy_list_file.read_text()
    )
